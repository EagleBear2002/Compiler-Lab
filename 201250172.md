...
java -jar /usr/local/lib/antlr-*-complete.jar -listener -visitor -long-messages ./src/SysYParser.g4 ./src/lexer.SysYLexer.g4
mkdir -p classes
javac -g -classpath /usr/local/lib/antlr-4.9.1-complete.jar ./src/Main.java ./src/lexer.MyLexerErrorListener.java ./src/parser.MyParserErrorListener.java ./src/S
...
rVisitor.java ./src/parser.Visitor.java -d classes
